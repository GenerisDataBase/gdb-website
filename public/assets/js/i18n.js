...
const PAGE_META = {
  ...
  "/products": {
    en: ["Qwizzy — the product by Generis Data Base", "Discover Qwizzy, the quiz app with 14,520 curated questions and 1,000 permanent achievement badges.", "Qwizzy — Generis Data Base", "14,520 curated questions, seven ways to play and 1,000 permanent achievement badges."],
    de: ["Qwizzy — das Produkt von Generis Data Base", "Entdecke Qwizzy, die Quiz-App mit 14.520 kuratierten Fragen und 1.000 dauerhaften Erfolgsabzeichen.", "Qwizzy — Generis Data Base", "14.520 kuratierte Fragen, sieben Spielmöglichkeiten und 1.000 dauerhafte Erfolgsabzeichen."],
    es: ["Qwizzy — el producto de Generis Data Base", "Descubre Qwizzy, la app con 14.520 preguntas seleccionadas y 1.000 insignias de logros permanentes.", "Qwizzy — Generis Data Base", "14.520 preguntas seleccionadas, siete formas de jugar y 1.000 insignias de logros permanentes."],
    it: ["Qwizzy — il prodotto di Generis Data Base", "Scopri Qwizzy, l'app con 14.520 domande curate e 1.000 badge traguardo permanenti.", "Qwizzy — Generis Data Base", "14.520 domande curate, sette modi di giocare e 1.000 badge traguardo permanenti."],
  },
  "/qwizzy": {
    en: ["Qwizzy — 14,520 quiz questions for iOS & Android | Generis Data Base", "Qwizzy is a multiple-choice quiz app with 14,520 curated questions across 25 categories, five difficulty levels and 33 language variants.", "Qwizzy — quiz app by Generis Data Base", "14,520 curated questions across 25 categories and 33 language variants."],
    de: ["Qwizzy — 14.520 Quizfragen für iOS & Android | Generis Data Base", "Qwizzy ist eine Multiple-Choice-Quiz-App mit 14.520 kuratierten Fragen in 25 Kategorien, fünf Schwierigkeitsstufen und 33 Sprachvarianten.", "Qwizzy — Quiz-App von Generis Data Base", "14.520 kuratierte Fragen in 25 Kategorien und 33 Sprachvarianten."],
    es: ["Qwizzy — 14.520 preguntas para iOS y Android | Generis Data Base", "Qwizzy es una app con 14.520 preguntas seleccionadas, 25 categorías, cinco niveles de dificultad y 33 variantes de idioma.", "Qwizzy — app de preguntas de Generis Data Base", "14.520 preguntas seleccionadas en 25 categorías y 33 variantes de idioma."],
    it: ["Qwizzy — 14.520 domande per iOS e Android | Generis Data Base", "Qwizzy è un'app quiz con 14.520 domande curate, 25 categorie, cinque livelli di difficoltà e 33 varianti linguistiche.", "Qwizzy — app quiz di Generis Data Base", "14.520 domande curate in 25 categorie e 33 varianti linguistiche."],
  },
  "/qwizzy-badges": {
...
const rows = {
  ...
  "14,520 curated and reviewed questions": ["14.520 kuratierten und geprüften Fragen", "14.520 preguntas seleccionadas y revisadas", "14.520 domande curate e revisionate"],
  ...
  "◆ 14,520 curated and reviewed questions": ["◆ 14.520 kuratierte und geprüfte Fragen", "◆ 14.520 preguntas seleccionadas y revisadas", "◆ 14.520 domande curate e revisionate"],
  ...
  "A multiple-choice quiz app with 14,520 curated and reviewed questions, organised into 25 categories, five difficulty levels and 33 language variants.": ["Eine Multiple-Choice-Quiz-App mit 14.520 kuratierten und geprüften Fragen in 25 Kategorien, fünf Schwierigkeitsstufen und 33 Sprachvarianten.", "Una app con 14.520 preguntas seleccionadas y revisadas, organizadas en 25 categorías, cinco niveles de dificultad y 33 variantes de idioma.", "Un'app quiz con 14.520 domande curate e revisionate, organizzate in 25 categorie, cinque livelli di difficoltà e 33 varianti linguistiche."],
  "Qwizzy for iOS and Android": ["Qwizzy für iOS und Android", "Qwizzy para iOS y Android", "Qwizzy per iOS e Android"],
  "For iPhone and iPad": ["Für iPhone und iPad", "Para iPhone y iPad", "Per iPhone e iPad"],
  "App Store": ["App Store", "App Store", "App Store"],
  "For Android": ["Für Android", "Para Android", "Per Android"],
  "Google Play": ["Google Play", "Google Play", "Google Play"],
  "Qwizzy is currently in testing. These permanent links will open the stores as soon as the public releases are available.": ["Qwizzy befindet sich derzeit in der Testphase. Diese dauerhaften Links öffnen die Stores, sobald die öffentlichen Versionen verfügbar sind.", "Qwizzy se encuentra actualmente en fase de pruebas. Estos enlaces permanentes abrirán las tiendas en cuanto estén disponibles las versiones públicas.", "Qwizzy è attualmente in fase di test. Questi link permanenti apriranno gli store non appena saranno disponibili le versioni pubbliche."],
  "Open Qwizzy in the App Store": ["Qwizzy im App Store öffnen", "Abrir Qwizzy en el App Store", "Apri Qwizzy nell'App Store"],
  "Open Qwizzy on Google Play": ["Qwizzy bei Google Play öffnen", "Abrir Qwizzy en Google Play", "Apri Qwizzy su Google Play"],
